  ...
  try {
    ...
    const products = [
      // Furniture
      {
        ...
        category: 'furniture',
        subcategory: 'Bed',
        description: 'Premium queen size wooden bed frame with a comfortable orthopedic mattress. Perfect for a good night\'s sleep in your rented apartment. Dimensions: 6.5ft x 5ft. Includes headboard, bed frame, and high-density foam mattress.',
      ...
      },
      {
        ...
        category: 'furniture',
        subcategory: 'Sofa',
        description: 'Elegant 3-seater fabric sofa with plush cushions and sturdy hardwood frame. Features premium upholstery fabric that is easy to clean and maintain. Ideal for living rooms in rental apartments.',
      ...
      },
      {
        ...
        category: 'furniture',
        subcategory: 'Table',
        description: 'Complete study setup with a spacious engineered wood table and ergonomic mesh chair. Features cable management holes, drawer storage, and adjustable chair height. Perfect for students and work-from-home professionals.',
      ...
      },
      {
        ...
        category: 'furniture',
        subcategory: 'Table',
        description: 'Beautiful 4-seater dining table set in solid rubber wood with a natural finish. Includes 4 matching chairs with cushioned seats. Compact design ideal for apartments and small dining spaces.',
      ...
      // Appliances
      {
        ...
        description: 'Energy-efficient 250-liter double door refrigerator with frost-free technology. Features vegetable crisper, bottle guard, and adjustable shelves. 3-star energy rating for lower electricity bills.',
      ...
      },
      {
        ...
        image: 'https://images.unsplash.com/photo-1631567091046-7e4c4a0d7f86?w=600',
        monthlyRent: 1299,
